...
```{r, include=T, out.width="80%", out.height="80%", fig.cap="Distribution du coefficient de variation dans les 3 blocs - mirna, mrna & protéine"}
...
```{r, include=T, out.width="80%", out.height="80%", fig.cap="Expliquation de la variabilité par les différente composante - avec center & scale false"}
...
```{r, include=T, out.width="80%", out.height="80%", fig.cap="Expliquation de la variabilité par les différente composante - avec center & scale true"}
...
```{r, include=T, out.width="80%", out.height="80%", fig.cap="PCA des gènes"}
...
```{r, include=T, out.width="80%", out.height="80%", fig.cap="PIndividus selon composantes 1-2 pcas"}
...
```{r, include=T, out.width="80%", out.height="80%", fig.cap="Spase PCA des gènes"}
...
```{r, include=T, out.width="80%", out.height="80%", fig.cap="Comparaisons des composantes 1 et 2 avec les groupes\n d'echantillons affiches en couleur"}
knitr::include_graphics("img/scatter_plot_pls.png")
```

```{r, include=T, out.width="80%", out.height="80%", fig.cap="Arrow plot des composantes 1 et 3"}
...
```{r, include=T, out.width="80%", out.height="80%", fig.cap="Heatmap ..."}
...
```{r, include=T, out.width="80%", out.height="80%", fig.cap="Block pls ..."}
...
```{r, include=T, out.width="80%", out.height="80%", fig.cap="Block spls ..."}
...
```{r, include=T, out.width="80%", out.height="80%", fig.cap="Individus selon composantes 1-2 PLS-DA"}
...
```{r, include=T, out.width="80%", out.height="80%", fig.cap="Block splsda all"}
...
```{r, include=T, out.width="80%", out.height="80%", fig.cap="Block splsda après sélection"}
plotIndiv(block.splsda.keepX, legend = T)
```

```{r, include=T, out.width="100%", out.height="100%", fig.cap="Circosplot"}
# Circosplot
...
P.heatmap
acp ? variables
répérer les points communément sur ou sous exprimés
